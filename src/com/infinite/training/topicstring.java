...
import com.infinite.practise.DataTypes;
...
//        obj.MultiDimensionArray();
        ...
        static <Stream> void f1(){
            ...
            System.out.println();
            String whiteSpaceLeadingAndTrailiing="   v i s h n u   . ";
            System.out.println("checking for the spaces:- "+whiteSpaceLeadingAndTrailiing);
            String whiteSpaceLeading="  v i s h n u  .";

            System.out.println("leading"+whiteSpaceLeading.strip());
            System.out.println("leading"+whiteSpaceLeading.stripLeading());
            System.out.println("leading"+whiteSpaceLeading.stripTrailing());
        ...
        //    String whiteSpaceLeading = "   Pacific";
            ...
            Stream lines = (Stream) str1.lines();
